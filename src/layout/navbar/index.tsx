...
import { AppHeaderNavigationList, UserMenuList } from "../../constants/menuList";
    ...
    <AppBar position="static">
      <Container maxWidth="xl">
        <Toolbar disableGutters>
          <Logo sx={{ display: { xs: 'none', md: 'flex' }, mr: 1, width: '2em', height: '2em' }} />
          <Typography
            variant="h6"
            noWrap
            component="a"
          ...
          <Logo sx={{ display: { xs: 'flex', md: 'none' }, mr: 1, width: '2em', height: '2em' }} />
          <Typography
            variant="h5"
            noWrap
            component="a"
